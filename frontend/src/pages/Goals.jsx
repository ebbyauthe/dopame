  ...
  return (
    <div className="space-y-8" data-testid="goals-page">
      <div className="flex items-center justify-between">
        <div>
          <p className="text-xs tracking-[0.2em] uppercase font-bold text-slate-600">Where you're headed</p>
          <h1 className="font-display text-3xl sm:text-4xl font-medium tracking-tight text-slate-900 mt-1">Goals</h1>
        </div>
